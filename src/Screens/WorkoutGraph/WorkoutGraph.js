...
export default function HistoryGraph({ navigation: { goBack } }) {
    ...
    const [workoutVolumeData, setworkoutVolumeData] = useState([])
    useEffect(()=>{
    ...
    const getExerciseGraphData = async () => {
        ...
        let data = await getWorkoutHistoryWeekly(month, day, year, workoutId)
        ...
        setworkoutVolumeData(exerciseData)
    }
    return (
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingVertical: hp(2) }}>
                    ...
                    <View style={Styles.section1.container}>
                        <View style={{ width: wp(85), flexDirection: "row", justifyContent: 'space-between' }}>
                            ...
                            >
                                <Text text="WORKOUT" textStyle={{ fontSize: wp(4), fontFamily: 'OpenSans-Semibold', color: blueColor }} />
                        ...
                        >
                            <GraphComp
                                ...
                                dataa={
                                    {
                                        labels: volumeDates.reverse(),
                                        datasets: [
                                            {
                                                data: volumeValues.reverse(),
                        ...
                        <HeadingComp text={workoutName} textStyle={{ fontSize: wp(5), marginHorizontal: wp(2), fontFamily: 'OpenSans-Bold' }} />

                        {buttonView === 'volume' && workoutVolumeData.length > 0 && <NeomorphFlexView
                        ...
                        >
                            ...
                            {
                                workoutVolumeData.length > 0 && workoutVolumeData.map((dt, i) => {
                                    return (
